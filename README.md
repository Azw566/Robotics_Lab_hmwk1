...
```bash
cd ~/ros2_ws
git clone https://github.com/Azw566/Robotics_Lab_hmwk1.git
colcon build 
...
Once gazebo is opened, in another terminal it is possible to start a controller. Two controllers are available:
* Position Controller
